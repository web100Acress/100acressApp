...
import {
  ...
  RecommendedProject,
} from "../../../api/Services/Recommended"; // 👈 path check
...
const RecommendedProjects = () => {
  ...
  useEffect(() => {
    (async () => {
      try {
        const data = await getRecommendedProject();
        setProjects(data);
      } catch (e) {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.subtitle}>
        Discover premium properties handpicked for luxury living and exceptional
        investment returns
      </Text>
