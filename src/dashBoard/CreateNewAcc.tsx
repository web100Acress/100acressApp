...
const CreateAccount = ({ navigation }: any) => {
  ...
  useEffect(() => {
    const checkLogin = async () => {
      ...
      if (loggedIn === "true") navigation.replace("Dashboard");
    };
    checkLogin();
  }, []);
    ...
    <SafeAreaView style={{ flex: 1 }}>
      ...
      >
        <ScrollView contentContainerStyle={{ padding: 24 }}>
          ...
          <Input label="Email" placeholder="Enter your email" value={email} onChange={setEmail} keyboardType="email-address" />
          <Input label="Mobile Number" placeholder="Enter mobile number" value={mobile} onChange={setMobile} keyboardType="number-pad" />
          <PasswordInput label="Password" placeholder="Enter password" value={password} onChange={setPassword} />
          <PasswordInput label="Confirm Password" placeholder="Re-enter password" value={confirmPassword} onChange={setConfirmPassword} />
          ...
          >
            <Text style={styles.linkText}>
              Already have an account? <Text style={{ fontWeight: "700", color: "#cb3535" }}>Login</Text>
            </Text>
          </TouchableOpacity>
        </ScrollView>
      </KeyboardAvoidingView>
...
const styles = StyleSheet.create({
  title: { fontSize: 28, fontWeight: "700", textAlign: "center", marginBottom: 6, color: "#e73636" },
  ...
  rolePill: { flex: 1, paddingVertical: 10, marginHorizontal: 4, borderRadius: 30, borderWidth: 1, borderColor: "#D1D5DB", alignItems: "center" },
  ...
  inputBox: { backgroundColor: "#F3F4F6", borderRadius: 14, paddingHorizontal: 16, borderWidth: 2, borderColor: "#f6d9d9" },
  input: { height: 52, fontSize: 16, color: "#111827" },
  passwordBox: { flexDirection: "row", alignItems: "center", backgroundColor: "#F3F4F6", borderRadius: 14, paddingHorizontal: 16, borderWidth: 2, borderColor: "#f6d9d9" },
  passwordInput: { flex: 1, height: 52, fontSize: 16, color: "#111827" },
  eyeText: { color: "#cb3535", fontWeight: "700", fontSize: 14 },
  cta: { height: 52, borderRadius: 14, backgroundColor: "#cb3535", justifyContent: "center", alignItems: "center", marginTop: 10 },
